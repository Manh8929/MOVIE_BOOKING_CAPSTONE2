    ...
    await queryInterface.bulkInsert("showtimes", [
      {
        ...
        screen_id: 1,
        status: "scheduled",
        show_time: new Date("2025-05-26T14:00:00Z"), // was 03:00
        ticket_price: 150000,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        screen_id: 2,
        status: "scheduled",
        show_time: new Date("2025-05-27T15:00:00Z"), // was 05:00
        ticket_price: 150000,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        screen_id: 1,
        status: "scheduled",
        show_time: new Date("2025-05-28T16:00:00Z"),
        ticket_price: 160000,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      ...
      },
      {
        ...
        screen_id: 2,
        status: "scheduled",
        show_time: new Date("2025-05-26T23:00:00Z"),
        ticket_price: 180000,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        screen_id: 1,
        status: "scheduled",
        show_time: new Date("2025-05-26T23:30:00Z"),
        ticket_price: 150000,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      ...
      // Ngày hôm sau
      {
        ...
        screen_id: 3,
        status: "scheduled",
        show_time: new Date("2025-05-26T01:00:00Z"),
        ticket_price: 180000,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        screen_id: 1,
        status: "scheduled",
        show_time: new Date("2025-05-25T03:00:00Z"),
        ticket_price: 190000,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
